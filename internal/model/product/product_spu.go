...
type ProductSpu struct {
	...
	SpecType           bool          `gorm:"default:false;comment:规格类型" json:"specType"` // false: 单规格, true: 多规格
	...
	DeliveryTypes      []int         `gorm:"column:delivery_types;type:json;serializer:json;comment:配送方式数组" json:"deliveryTypes"`
	...
	SubCommissionType  bool          `gorm:"default:false;comment:分销类型" json:"subCommissionType"` // false: 默认, true: 自行设置
